    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dye_goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='warehouse_management.Inventory', verbose_name='染色产品')),
                ('process', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseData.Client', verbose_name='打毛厂')),
            ],
            options={
                'verbose_name': '打毛领料',
                'verbose_name_plural': '打毛领料',
            },
        ),
        migrations.CreateModel(
            name='HairingReturn',
            fields=[
                ...
                ('piece', models.FloatField(blank=True, null=True, verbose_name='件数')),
                ('price', models.FloatField(verbose_name='成本单价')),
                ('total', models.FloatField(default=0, verbose_name='成本总额')),
                ...
                ('A', models.FloatField(blank=True, default=0.98, verbose_name='评估打毛回毛率')),
                ('A1', models.FloatField(blank=True, default=0.0, verbose_name='实际打毛回毛率')),
                ...
                ('hairing', models.ManyToManyField(related_name='hairing_return', to='hairing.Hairing', verbose_name='所属打毛领料单号')),
